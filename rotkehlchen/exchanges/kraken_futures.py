...
from rotkehlchen.exchanges.kraken import Kraken, DEFAULT_KRAKEN_ACCOUNT_TYPE, KrakenAccountType
...
class KrakenFutures(Kraken):
    ...
    # TODO: This is instead of query_private
    ...
    # TODO: Almost unchanged, just used FUTURES URL and 'accounts' instead
    ...
    def query_balances(self) -> ExchangeQueryBalances:
        try:
            ...
            log.info(f'got kraken ftures balances for {kraken_balances}')
        ...
        return dict(assets_balance), 'kraken_futures_balances'
